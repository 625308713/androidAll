...
import com.dai.daicommon.event.TabSelectedEvent;
import com.dai.daicommon.view.BottomBar;
import com.dai.daicommon.view.BottomBarTab;
...
public class MainFragment extends SupportFragment {
    ...
    private void initView(View view) {
        ...
        mBottomBar
                .addItem(new BottomBarTab(_mActivity, R.mipmap.ic_message_white_24dp, getString(R.string.msg)))
                .addItem(new BottomBarTab(_mActivity, R.mipmap.ic_account_circle_white_24dp, getString(R.string.discover)))
                .addItem(new BottomBarTab(_mActivity, R.mipmap.ic_discover_white_24dp, getString(R.string.more)));
