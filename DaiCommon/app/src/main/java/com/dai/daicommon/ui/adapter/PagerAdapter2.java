 ...
 */
public class PagerAdapter2 extends RecyclerView.Adapter<PagerAdapter2.MyViewHolder> {
    ...
    public void setOnItemClickListener(OnItemClickListener2 itemClickListener) {
